...
driver = write_init()
sleep(2)
write_post(driver,'//*[@id="in-category-17"]', els_title(), els_tag(),els_post())
driver.implicitly_wait(1000)
sleep(2)
write_post(driver,'//*[@id="in-category-17"]', saving_title(), saving_tag(), saving_post())
driver.implicitly_wait(1000)
sleep(2)
write_post(driver,'//*[@id="in-category-17"]', ins_saving_title(), ins_saving_tag(),ins_saving_post())
