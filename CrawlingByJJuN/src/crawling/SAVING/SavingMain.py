...
def str_saving():
    ...
    str_return +=  "<br/>"
    str_return +=  "<hr/>"
    str_return +=  "은행  12개월 정기예금  - 우대금리 Top 10"
    str_return +=  "<br/>"
    ...
    #정기예금 - 우대 비포함
    str_return +=  "<hr/>"
    str_return +=  "은행  12개월 정기예금 - 단순금리  Top 10"
    str_return +=  "<br/>"
    ...
    #정기예금 - 우대포함
    str_return +=  "<hr/>"
    str_return +=  "저축은행 12개월 정기예금 - 우대금리 Top 10"
    str_return +=  "<br/>"
    topsaving_list=JSONParser4SAVING.savingparser('저축은행', '예금', 1)
    str_return += MakeSAVINGHtml.make_str_produchtml(topsaving_list)
    #정기예금 - 우대비포함
    str_return +=  "<hr/>"
    str_return +=  "저축은행 12개월 정기예금 - 일반금리 Top 10"
    str_return +=  "<br/>"
...
def str_inssaving():
    ...
    str_return +=  "<br/>"
    str_return +=  "<hr/>"
    str_return +=  "은행  12개월 정기적금  - 우대금리 Top 10"
    str_return +=  "<br/>"
    topsaving_list=JSONParser4SAVING.savingparser('은행', '적금', 1)
    str_return += MakeSAVINGHtml.make_str_produchtml(topsaving_list)
    #정기적금 - 우대 비포함
    str_return +=  "<hr/>"
    str_return +=  "은행  12개월 정기적금 - 단순금리  Top 10"
    str_return +=  "<br/>"
    ...
    #정기적금 - 우대포함
    str_return +=  "<hr/>"
    str_return +=  "저축은행 12개월 정기적금 - 우대금리 Top 10"
    str_return +=  "<br/>"
    topsaving_list=JSONParser4SAVING.savingparser('저축은행', '적금', 1)
    str_return += MakeSAVINGHtml.make_str_produchtml(topsaving_list)
    #정기적금 - 우대비포함
    str_return +=  "<hr/>"
    str_return +=  "저축은행 12개월 정기적금 - 일반금리 Top 10"
    str_return +=  "<br/>"
